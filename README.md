...
HealthcheckWatch is a "Dead Man's Switch" designed to monitor cron scripts execute to completion. If your scripts silently 
hang, crash, or fail to run, HealthcheckWatch sends you an email alerting before the silence becomes a problem.
